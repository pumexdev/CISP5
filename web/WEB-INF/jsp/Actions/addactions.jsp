<%-- 
    Document   : addactions
    Created on : 12 Mar, 2015, 11:40:58 AM
    Author     : user
--%>
...
<script type="text/javascript" src="js/Actions/addactions.js"></script>
<form:form modelAttribute="AddActions">
            ...
            <div id="message">
                <c:if test="${param.add=='true'}">
                    <div class="success_div" id="message">                      
                        <div id="message" class="success">Actions saved Successfully</div>
                    </div>
                </c:if>
                <c:if test="${param.add=='false'}">
                    <div class="failed_div" id="message">                       
                        <div id="message" class="failed">Error while saving Actions</div>                        
                    </div>
                </c:if>
            </div>
            <div class="addcentr_top">Add Actions</div>
            <div class="addcentr_fldarea">
                <div class="row">
                    <div id="invalid-process" class="errordiv"></div>
                ...
                <div class="row">
                    ...
                    <div class="left">Sub-Process&nbsp;<font class="error" style="color: red;">*</font></div>
                    <div class="right">
                ...
                <div class="row">
                    <div id="invalid-percentage" class="errordiv"></div>
