<%-- 
    Document   : editbenchmark
    Created on : Jul 23, 2012, 10:10:07 AM
    Author     : user
--%>
...
<script type="text/javascript" src="js/Benchmark/editbenchmark.js"></script>
...
<form:form modelAttribute="EditBenchmark">
    <fieldset class="forms" style="width: 55%">
        ...
        <table width="102%">
            ...
            <td>
                <form:select path="paramtypecode" id="paramtypecode" onchange="getProcessValidate(this.value)">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;
                    <input type="button" value="Cancel" onclick="location.href='searchbenchmark.htm'">
                </td>                
            </tr>
        </table>
    </fieldset>
