                    ...
                    <form:form modelAttribute="processingBean">
                        ...
                        <div class="addcentr_fldarea" style="padding:10px 26px 62px 26px!important">
                            <div class="row">
                                ...
                                <div class="right">
                                    <form:input type="text" path="bussiness_center" readonly="true" style="width:0%"/>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="right">
                                    <form:input type="text" path="date" readonly="true" style="width:0%"/>
                            ...
                            <div class="row">
                                ...
                                <div class="right" style="width: auto !important">
                                    <form:input type="text" path="location_cord" readonly="true" style="width:0%"/>
                                </div>
                            </div>
                            <%--<div class="row">
                                <div class="errordiv"></div>
                                ...
                                <div class="right">
                                    <form:input type="text" path="business" readonly="true"/>
                                </div>
                            </div>--%>
                            <div class="row">
                                <div class="errordiv"></div>
                                <div class="left">Total Entries</div>
                                <div class="right"><form:input type="text" path="totalEntries" readonly="true" style="width:0%"/></div>
                            </div>
                            <div class="row">
                                <div class="errordiv"></div>
                                <div class="left">Total Compensation</div>
                                <div class="right"><form:input type="text" path="totalComp" readonly="true" style="width:0%"/></div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="right"><form:input path="status" readonly="true" id="status" style="width:0%"></form:input>
                                    <c:if test="${processingBean.date_flag==false}">
                                        <form:checkbox id="dateCheck" style="width:15%;height:15%" value="true" path="date_check" onchange="dateOverWrite()"/><span style="font-weight: bolder;padding-left: 5px">Accept this file</span>
                                    </c:if>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="addbottom_fldarea">
                            <div class="addbottom_left">
                                <input type="button" name="confirm" disabled="true" id="confirm" value="Save" onclick="saveHRData(this.form)"/>
                                <input type="reset" name="Cancel" id="cancel"value="Cancel" onclick="cancelFunction('exceluploader.htm')"/>
                            </div>
                        </div>
                    </form:form>
                </div>
