<%-- 
    Document   : laborcostpertransaction
    Created on : Apr 23, 2015, 12:05:14 PM
    Author     : Vishnu AU
--%>
...
<script type="text/javascript" src="js/Target/lcostpertransdashboard.js"></script>
...
<form:form modelAttribute="TLcostPerTransDashBoard">
    <div class="global_area_main">
        <!-- Dashboard Menu starts-->
        <div class="d2_menu_nav_out">
            <div class="left_text_menu">Labor Cost Per Transaction Dashboard</div>
                                                ...
                                                <div class="box_expand_style  expand_box2 expand_box_leftmargin ">
                                                    ...
                                                    <div class="box_content box_background_grey" style="height:25px;">
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody id="targettab">                                                           
                                                                <tr>
                                                                    <td style="width: 69%;float: none;text-align: right;padding: 0px;" id="targetv"><input type='text' style="text-align: right; margin-left: 13%!important; margin-right: 18%!important;" id='target' class="target2" maxlength="10" disabled="true"/></td>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="expand_box3 box_textf2"><input type='text' style="text-align: right;min-width: 85% !important;margin-top: 12%;" id='high' class="high2" maxlength="10" disabled="true"/></div>
                                                        <div class="expand_box3 box_border_right box_textf3" style="width: 49%;">Medium</div>
                                                        <div class="expand_box3 box_textf4"><input type='text' style="text-align: right;min-width: 85% !important;margin-top: 12%;" id='medium' class="medium2" maxlength="10" disabled="true"/></div>
                                                        <div class="expand_box3 box_border_right box_textf" style="width: 49%;">Low</div>
                                                        <div class="expand_box3 box_textf2"><input type='text' style="text-align: right;min-width: 85% !important;margin-top: 12%;" id='low' class="low2" maxlength="10" disabled="true"/></div>
