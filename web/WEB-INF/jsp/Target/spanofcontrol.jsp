<%-- 
    Document   : spanofcontrol
    Created on : Apr 23, 2015, 12:50:15 PM
    Author     : Vishnu AU
--%>
...
<script type="text/javascript" src="js/Target/lcostperftedashboard.js"></script>
...
<form:form modelAttribute="SpanofControlDashBoard">
    <div class="global_area_main">
        <!-- Dashboard Menu starts-->
        <div class="d2_menu_nav_out">
            <div class="left_text_menu">Span of Control Dashboard</div>
...
<!--                        <div class="scrollbar" id="style-2">
                            <div class="track" style="height: 290px;">style="height: 290px;"
                                <div class="thumb" style="height: 102.561px;">style="height: 102.561px;"
                                    <div class="end"></div>
                                </div>
                            </div>
                        </div>-->
                                    ...
                                    <div id="tab1" class="tabcontent">
                                        ...
                                        <div class="expand_style" style="margin-top: 3px;overflow:auto; height:100%;min-height:750px;"><!--min-height:750px;-->
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">S2.4 What is the span of control (% resources per Tier)?How has that changed?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv21">What is the average span of control for this Sub-Process? Are changes consistent with your plan or strategy?</div>
                                            <div class="graphOuter">
                                                <!--New Design-->
                                                <div class="box_expand_style  expand_box1">
                                                    <div class="top_bar">
                                                        <div class="txt_head01 expand_box_textleft">Tier 1 Manager</div>
                                                        <div class="txt_head01 expand_box_textleft">Tier 2 Supervisor</div>
                                                        <div class="txt_head01 expand_box_textleft">Tier 3 Analyst</div>
                                                    </div>
                                                ...
                                                <div class="box_expand_style  expand_box2 expand_box_leftmargin ">
                                                    ...
                                                    <div class="box_content box_background_grey" style="height:25px;">
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody id="targettab">                                                           
                                                                <tr>
                                                                    <td style="width: 69%;float: none;text-align: right;padding: 0px;" class="target3" id="targetv"><input type='text' style="text-align: right; margin-left: 13%!important; margin-right: 18%!important;" id='target' class="target3" maxlength="10" disabled="true"/></td>
                                                                    <!--<td style="width: 29%;float: right;"></td>img id="metricedit${loop.index+1}" onclick="targetEditClick(target.value, this)"src="images/edit.png" alt="Edit" title="Edit"  style="cursor: pointer"/-->
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                            <!--<h3 class="expand_box_textcenter target3">0<img id="metricedit${loop.index+1}" onclick="load('editmetric.htm?mid=${metric.MetricId}')"src="images/edit.png" alt="Edit" title="Edit"  style="cursor: pointer"/></h3>-->
                                                    </div>
                                                </div>
                                            ...
                                            <div class="box_expand_style_1  expand_box2 expand_box_leftmargin ">
                                               <div class="top_bar">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="expand_box3 box_textf2 "><input type='text' style="text-align: right;min-width: 85% !important;margin-top: 12%;" id='high' class="high3" maxlength="10" disabled="true"/></div>
                                                    <div class="expand_box3 box_border_right box_textf3" style="width: 49%;">Medium</div>
                                                    <div class="expand_box3 box_textf4"><input type='text' style="text-align: right;min-width: 85% !important;margin-top: 12%;" id='medium' class="medium3" maxlength="10" disabled="true"/></div>
                                                    <div class="expand_box3 box_border_right box_textf" style="width: 49%;">Low</div>
                                                    <div class="expand_box3 box_textf2"><input type='text' style="text-align: right;min-width: 85% !important;margin-top: 12%;" id='low' class="low3" maxlength="10" disabled="true"/></div>
