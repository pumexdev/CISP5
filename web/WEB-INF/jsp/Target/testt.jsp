<%-- 
    Document   : testt
    Created on : May 12, 2015, 2:36:03 PM
    Author     : Vishnu AU
--%>
...
<form:form modelAttribute="TVolumeperFTEDashBoard">
    <div class="global_area_main">
        ...
        <div style="overflow: auto;height: 74%">
                ...
                <div class="overview">
                    ...
                    <div id="content">
                        <div id="tab1" class="tabcontent">
                            <div class="expand_style" style="margin-top: 3px; height:auto;"><!--min-height:750px;-->
                                <div class="top_bar">
                                    ...
                                    <div class="box_expand_style  expand_box2 expand_box_leftmargin ">
                                        ...
                                        <div class="box_content box_background_grey" style="height:25px;">
                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                <tbody id="targettab">                                                           
                                                    <tr>
                                                        <td style="width: 100%;float: none;text-align: right;padding: 0px;" id="targetv"><input type='text' style="text-align: right; margin-left: 13%!important; margin-right: 18%!important;" id='target' class="target1" maxlength="10" disabled="true"/></td>
