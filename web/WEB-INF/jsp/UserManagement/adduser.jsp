...
<script type="text/javascript" src="js/UserManagement/createuser.js"></script>
<form:form modelAttribute="User" onsubmit="return checkUser($('#username').val());">
        ...
        <div class="addcentr_area" style="width: 45%">
            <c:if test="${param.add=='true'}">
                <div class="success_div" id="message">                      
                    <div id="message" class="success">User details saved Successfully</div>
                </div>
            </c:if>
            <c:if test="${param.add=='false'}">
                <div class="failed_div" id="message">                       
                    <div id="message" class="failed">Error while saving User details</div>                        
                </div>
            </c:if>
            <div class="addcentr_top">Add User </div>
            <div class="addcentr_fldarea">
                <div class="row">
                    <div id="invalid-username" class="errordiv"></div>
                    <div class="left">User Name&nbsp;<font class="error" style="color: red;">*</font></div>
                    <div class="right">
                        <form:input path="username" type="text" id="username" maxlength="60" onchange="checkUser(this.value)" onfocus="$('#usercheck').html('');$('.success_div').hide()"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="row">
