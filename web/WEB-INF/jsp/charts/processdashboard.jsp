...
<script type="text/javascript" src="js/dashboard/processdashboard.js"></script>
...
<form:form modelAttribute="GlobalDashBoard">
    <div class="global_area_main">
        ...
        <div class="d2_menu_nav_out">
            <div class="left_text_menu">Process Dashboard</div>
        ...
        <div class="date_area">
            <div class="date_right">
                ...
                <c:if test="${UserBean.userlevel!='5'}">
                    <div class="date_text01">Process<span>*</span></div>
                    <div class="date_left">
                        <form:select id="process1" path="processId" onchange="onChange(this.id, this.value,'pid');$('#processText').val(returnOptionText(this.id,this.value))">
                            <form:option value="">Select</form:option>
                            <form:options items="${dashboardprocess}"></form:options>
                        </form:select>
                    </div>
                </c:if>
                <c:if test="${UserBean.userlevel=='5'}">
                    <input type="hidden" id="process1" value="${defaultProcess}"/>
                </c:if>
        ...
        <div style="height: 90%"><!--style="height: 90%"-->
            <div class="test01">
                                    ...
                                    <div id="tab1" class="tabcontent">
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P1.1 How many resources for this process across the Centers?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv1">How many resources are dedicated to this process across the Centers? Are changes consistent with your plan and strategy?</div>
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P1.2 How has that changed?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv2">How many resources are dedicated to this process across the Centers? Are changes consistent with your plan and strategy?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P1.3 What is the average labor cost across your Centers?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv3">What is the average labor cost for this process across the Centers? It consistent with your plan? Should work be moved to take advantage of differences?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P1.4 How has that changed?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv4">What is the average labor cost for this process across the Centers? It consistent with your plan? Should work be moved to take advantage of differences?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P1.5 What is the GLOBAL average labor cost across your Centers?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv5">What is the average labor cost for this process across the Centers? It consistent with your plan? Should work be moved to take advantage of differences?</div>
                                            <div class="graphOuter">
                                    ...
                                    <div id="tab2" class="tabcontent" style="display: none">
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P2.1 For the selected process, what is the total resources per Tier across the Centers?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv6">What is the average span of control for this Process? Are changes consistent with your plan or strategy?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P2.2 How has that changed?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv7">What is the average span of control for this Process? Are changes consistent with your plan or strategy?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P2.3 What is the span of control (% resources per Tier)?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv8">What is the average span of control for this Process? Are changes consistent with your plan or strategy?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P2.4 How has that changed?</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv9">How does the average span of control for this Process compare across Centers? Should the leading Center be the benchmark for others?</div>
                                            <div class="graphOuter">
                                        ...
                                        <div class="expand_style">
                                            <div class="top_bar">
                                                ...
                                                <div class="ex_left02">P2.5 How does Span of Control compare? Tier 3 Comparison to other Centers</div>
                                                <div class="ex_right">
                                            ...
                                            <div class="chartdescdiv" id="chartdescdiv10">How does the average span of control for this Process compare across Centers? Should the leading Center be the benchmark for others?</div>
                                            <div class="graphOuter">
                ...
                <div class="slide_right_panel">
                    ...
                    <div class="side_panel_icon"><a href="#" title="EXCEL" onclick="processdownload()"><div class="side_button01"><div class="side-image2"></div></div></a></div>
                ...
                <div id="preferences" style="display:none;">
                    <div class="expanded_box01">
                        ...
                        <div class="get-button_main"><a href="#" onclick="processdownload()"><div class="get-button">EXCEL<div class="get-image2"></div></div></a></div>   
                        <div class="clear"></div>                
                        <div class="get_area">
                            <div class="quote">
                                <div class="q_inner_top">
                                    <p class="q_text">Dashboard: Process</p>
                                    <p>View of process resources, cost and performance across centers. Ability
                                       to drive improvement opportunities across centers, and spot trends.</p>
                                </div>
...
<div style="display: none">
    ...
    <input type="hidden" id="processText" value="${processText}"/>
