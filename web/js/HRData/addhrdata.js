...
{
    var tablelength=($("#empdet tbody tr").length)-3;
    if(tablelength==0)
...
{
    var compensation=$("#total_compensation1").val();
    ...
    $("#"+id).html(parseFloat(compensation*value).toFixed(2));
}

function iterateAllSums()
{
    var sum=0.0;
    $("input[name^='fte']").each(function(){
        var value=$(this).val();
...
{
    $("#total_compensation1").change(function()
    {
       //compensation1
        var count = 1;
        var compensation=$("#total_compensation1").val();
