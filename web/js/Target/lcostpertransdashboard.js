...
function targetEfficiency()
{
    ...
    changeGraph2('ajaxtargeteffgraph2.htm', params, array1, array2, 'Average labor cost per transaction', 'Center', 'Average Labor cost', 'graphdiv14');
...
function targetEditClick(target,rowid){
     var newhtml="";
    newhtml=newhtml+"<td style='width: 69%;float: none;text-align: right;'><input type='text' style='text-align: right;' class='target2' id='target' value='"+target+"'/></td>";
...
function targetSaveClick(target,rowid){
    ...
    saveTarget();
     var newhtml="";
    newhtml=newhtml+"<td style='width: 69%;float: none;text-align: right;'><input type='text' class='target2' style='text-align: right;' id='target' value='"+target+"' disabled='true'/></td>";
