...
function targetEfficiency()
{
    ...
    var params = {date: array1, spid: spid, bcid: bcid, tier: tier};
     changeGraph2('ajaxtargeteffgraph1.htm', params, array1, array2, 'Sub-Process Volume per FTE', 'Center', 'Volume', 'graphdiv12');
...
function targetEditClick(target, rowid) {
    var newhtml = "";
    newhtml = newhtml + "<td style='width: 69%;float: none;text-align: right;'><input type='text' style='text-align: right;' class='target1' id='target' value='" + target + "'/></td>";
...
function targetSaveClick(target, rowid) {
    ...
    saveTarget();
    var newhtml = "";
    newhtml = newhtml + "<td style='width: 69%;float: none;text-align: right;'><input type='text' class='target1' style='text-align: right;' id='target' value='" + target + "' disabled='true'/></td>";
